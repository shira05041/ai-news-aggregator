...
from app.scrapers.youtube import YouTubeScrapper
from app.database.repository import Repository


TRANSCRIPT_UNAVALABLE_MAKER = "__UNAVALABLE__"


def process_youtube_transcript(limit: Optional[int] = None) -> dict:
    ...
    for video in videos:
        try:
            ...
            if transcript_result:
                ...
                repo.update_youtube_video_transcript(video.video_id, TRANSCRIPT_UNAVALABLE_MAKER)
                unavailable += 1
...
if __name__ == "__main__":
    result = process_youtube_transcript()
